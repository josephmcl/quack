...
/* Constructor */
obj_Obj new_Obj(  ) {
  obj_Obj new_thing = (obj_Obj) GC_MALLOC(sizeof(struct obj_Obj_struct));
...
obj_String new_String(  ) {
  obj_String new_thing = (obj_String) GC_MALLOC(sizeof(struct obj_String_struct));
...
obj_Boolean new_Boolean(  ) {
  obj_Boolean new_thing = (obj_Boolean)
    GC_MALLOC(sizeof(struct obj_Boolean_struct));
...
obj_Nothing new_Nothing() {
  obj_Nothing new_thing = (obj_Nothing) GC_MALLOC(sizeof(struct obj_Nothing_struct));
  new_thing->clazz = the_class_Nothing;
  return new_thing;  
}
...
obj_Int new_Int(  ) {
  obj_Int new_thing = (obj_Int)
    GC_MALLOC(sizeof(struct obj_Int_struct));
...
obj_Boolean Int_method_LESS_EQUALS(obj_Int this, obj_Int other) {
  if (this->value <= other->value) {
    return lit_true;
  }
  return lit_false;
...
/* ADD (new method) */
obj_Int Int_method_ADD(obj_Int this, obj_Int other) {
  return int_literal(this->value + other->value);
}
/* SUB (new method) */
obj_Int Int_method_SUB(obj_Int this, obj_Int other) {
  return int_literal(this->value - other->value);
}
/* TOMES (new method) */
obj_Int Int_method_MUL(obj_Int this, obj_Int other) {
  return int_literal(this->value * other->value);
}
/* DIV (new method) */
