...
struct class_Int_struct {
  ...
  obj_Boolean (*LESS_EQUALS) (obj_Int, obj_Int);   /* Introduced */
  obj_Int (*ADD) (obj_Int, obj_Int);       /* Introduced */
  obj_Int (*SUB) (obj_Int, obj_Int);       /* Introduced */
  obj_Int (*MUL) (obj_Int, obj_Int);       /* Introduced */
